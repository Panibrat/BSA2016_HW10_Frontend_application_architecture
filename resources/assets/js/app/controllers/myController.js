...
var BooksCollection = require('../collections/BooksCollection');
var BookDetailView = require('../views/books/BookDetailView');
var BookDetailEdit = require('../views/books/BookDetailEdit');
var BooksView = require('../views/books/BooksView');
var UsersBooksView = require('../views/books/UsersBooksView');
//var BookView = require('../views/books/BookView');

var UserModel = require('../models/UserModel');
var UsersCollection = require('../collections/UsersCollection');
var UserDetailView = require('../views/users/UserDetailView');
var UserDetailEdit = require('../views/users/UserDetailEdit');
